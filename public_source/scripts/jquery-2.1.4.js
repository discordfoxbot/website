            ...
            Expr = Sizzle.selectors = {
                ...
                pseudos: {
                    ...
                    "contains": markFunction(text => {
                        ...
                        return elem => (elem.textContent || elem.innerText || getText( elem )).includes(text);
                    }),
...
// Use getAttributeNode to fetch booleans when getAttribute lies
    ...
    var access = jQuery.access = (elems, fn, key, value, chainable, emptyGet, raw) => {
        var i = 0,
            len = elems.length,
            bulk = key == null;
     ...
     */
    jQuery.acceptData = owner => // Accepts only:
    //  - Node
    //    - Node.ELEMENT_NODE
    //    - Node.DOCUMENT_NODE
    //  - Object
        ...
        data: function( key, value ) {
            ...
            return access( this, function( value ) {
                ...
                this.each(function() {
                    ...
                    // unchanged property.
                    if ( key.includes("-") && data !== undefined ) {
    ...
    jQuery.fn.extend({
        ...
        hasClass: function( selector ) {
            var className = ` ${selector} `,
                ...
                l = this.length;
            for ( ; i < l; i++ ) {
                if ( this[i].nodeType === 1 && (` ${this[i].className} `).replace(rclass, " ").includes(className) ) {
                    return true;
                }
            }
