...
!(t => {
    function n() {
        t[s].glbl || (d = {
            ...
            $html: t("html"),
            $body: t("body")
        }, a = {}, l = {}, r = {}, t.each([a, l, r], (e, t) => {
            t.add = e => {
                e = e.split(" ");
                for (var n in e)t[e[n]] = t.mm(e[n])
            }
        }), a.mm = e => `mm-${e}`, a.add("wrapper menu vertical panel nopanel current highest opened subopened header hasheader title btn prev next first last listview nolistview selected divider spacer hidden fullsubopen"), a.umm = e => ("mm-" == e.slice(0, 3) && (e = e.slice(3)), e), l.mm = e => `mm-${e}`, l.add("parent sub"), r.mm = e => `${e}.mm`, r.add("transitionend webkitTransitionEnd mousedown mouseup touchstart touchmove touchend click keydown"), t[s]._c = a, t[s]._d = l, t[s]._e = r, t[s].glbl = d)
    }
        ...
        t[s] = function (e, t, n) {
            ...
            init: function (e) {
                ...
                if (n.hasClass(a.vertical)) {
                    ...
                    i.removeClass(a.highest).removeClass(a.current).not(e).not(l).not(`.${a.vertical}`).addClass(a.hidden), e.hasClass(a.opened) ? l.addClass(a.highest).removeClass(a.opened).removeClass(a.subopened) : (e.addClass(a.highest), l.addClass(a.subopened)), e.removeClass(a.hidden).addClass(a.current), setTimeout(() => {
                ...
                for (var e in t[s].addons)t[s].addons[e].add.call(this), t[s].addons[e].add = () => {
                };
...
!(e => {
    ...
    e[t].addons[o] = {
        ...
        var t = [s.opened];
        this.opts[o].modal && t.push(s.modal), this.opts[o].moveBackground && t.push(s.background), "left" != this.opts[o].position && t.push(s.mm(this.opts[o].position)), "back" != this.opts[o].zposition && t.push(s.mm(this.opts[o].zposition)), this.opts.extensions && t.push(this.opts.extensions), a.$html.addClass(t.join(" ")), setTimeout(() => {
            e.vars.opened = !0
    ...
    }, e[t].prototype[`_initWindow_${o}`] = () => {
        a.$wndw.off(`${i.keydown}-offcanvas`).on(`${i.keydown}-offcanvas`, e => a.$html.hasClass(s.opened) && 9 == e.keyCode ? (e.preventDefault(), !1) : void 0);
        var e = 0;
        a.$wndw.off(`${i.resize}-offcanvas`).on(`${i.resize}-offcanvas`, (t, o) => {
        ...
        var t = this;
        a.$blck || (a.$blck = e(`<div id="${s.blocker}" class="${s.slideout}" />`)), a.$blck.appendTo(a.$body).off(`${i.touchstart}-offcanvas ${i.touchmove}-offcanvas`).on(`${i.touchstart}-offcanvas ${i.touchmove}-offcanvas`, e => {
            e.preventDefault(), e.stopPropagation(), a.$blck.trigger(`${i.mousedown}-offcanvas`)
        }).off(`${i.mousedown}-offcanvas`).on(`${i.mousedown}-offcanvas`, e => {
        ...
        setup: function () {
            if (this.opts.offCanvas) {
                ...
                if (this.conf[i], h = t[e].glbl, "boolean" == typeof o && o && (o = {height: "auto"}), "object" != typeof o && (o = {}), o = this.opts[i] = t.extend(!0, {}, t[e].defaults[i], o), "auto" == o.height) {
                    ...
                    this.bind("update", u), this.bind("openPanel", u), this.bind("closePanel", u), this.bind("open", u), h.$wndw.off(`${a.resize}-autoheight`).on(`${a.resize}-autoheight`, () => {
                        u.call(n)
                    })
                }
            }
        ...
        setup: function () {
            if (this.opts.offCanvas) {
                ...
                if (this.conf[n], a = o[t].glbl, "boolean" == typeof e && (e = {close: e}), "object" != typeof e && (e = {}), e = o.extend(!0, {}, o[t].defaults[n], e), e.close) {
                    ...
                    }), o(window).on("popstate", o => {
                        a.$html.hasClass(s.opened) ? (o.stopPropagation(), i.close()) : location.hash == c && (o.stopPropagation(), i.open())
                    })
                }
            }
        }, add: function () {
            return window.history && window.history.pushState ? (s = o[t]._c, i = o[t]._d, e = o[t]._e, void 0) : (o[t].addons[n].setup = () => {
            }, void 0)
        }, clickAnchor: function () {
        }
    ...
    i[e].addons[s] = {
        setup: function () {
            ...
            if (this.conf[s], l = i[e].glbl, "boolean" == typeof a && (a = {
                ...
                this.$fixeddivider = i(`<ul class="${d.listview} ${d.fixeddivider}"><li class="${d.divider}"></li></ul>`).prependTo(this.$menu).children(), this.bind("openPanel", o), this.bind("init", e => {
    ...
    t[e].addons[o] = {
        setup: function () {
            ...
            if (this.$footer = this.$menu.children(`.${n.footer}`), i.update && this.$footer && this.$footer.length) {
                var d = function(e = this.$menu.children(`.${n.current}`)) {
    ...
    e[t].addons[a] = {
        setup: function () {
            ...
            if (this.conf[a], s = e[t].glbl, "boolean" == typeof i && (i = {
                ...
                e(`<div class="${n.header}" />`).prependTo(this.$menu).append(d), this.$menu.addClass(n.hasheader), this.bind("init", e => {
                    e.removeClass(n.hasheader)
                })
            }
            if (this.$header = this.$menu.children(`.${n.header}`), i.update && this.$header && this.$header.length) {
                var c = this.$header.find(`.${n.title}`), o = this.$header.find(`.${n.prev}`), f = this.$header.find(`.${n.next}`), p = this.$header.find(`.${n.close}`), u = function(e = this.$menu.children(`.${n.current}`)) {
                ...
                d.search && e(`.${t.search}`, this.$menu).each(function () {
                    ...
                    var c = a.children("input"), h = o.__findAddBack(n, `.${t.listview}`).children("li"), u = h.filter(`.${t.divider}`), f = o.__filterListItems(h), p = "> a", v = `${p}, > span`, m = function () {
                        ...
                        n.scrollTop(0), f.add(u).addClass(t.hidden).find(`.${t.fullsubopensearch}`).removeClass(t.fullsubopen).removeClass(t.fullsubopensearch), f.each(function () {
                            var a = e(this), n = p;
                            (d.showTextItems || d.showSubPanels && a.find(`.${t.next}`)) && (n = v), e(n, a).text().toLowerCase().includes(s) && a.add(a.prevAll(`.${t.divider}`).first()).removeClass(t.hidden)
                            ...
                            n && (o.__filterListItems(a.find(`.${t.listview}`).children()).length ? (n.hasClass(t.hidden) && n.children(`.${t.next}`).not(`.${t.fullsubopen}`).addClass(t.fullsubopen).addClass(t.fullsubopensearch), n.removeClass(t.hidden).removeClass(t.nosubresults).prevAll(`.${t.divider}`).first().removeClass(t.hidden)) : "menu" == d.addTo && (a.hasClass(t.opened) && setTimeout(() => {
                    ...
                    c.off(`${i.keyup}-searchfield ${i.change}-searchfield`).on(`${i.keyup}-searchfield`, e => {
